...
public final class DialogCheckinBinding implements ViewBinding {
  ...
  private DialogCheckinBinding(@NonNull LinearLayout rootView, @NonNull Button btnSubmit,
      @NonNull EditText etNote) {
  ...
  public static DialogCheckinBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogCheckinBinding((LinearLayout) rootView, btnSubmit, etNote);
    }
