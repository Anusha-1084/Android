...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull RelativeLayout rootView, @NonNull Button btnLogin,
      @NonNull EditText etPassword, @NonNull EditText etUsername, @NonNull LinearLayout loginBox,
      @NonNull ProgressBar loginProgress, @NonNull TextView tvSignup) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((RelativeLayout) rootView, btnLogin, etPassword, etUsername,
          loginBox, loginProgress, tvSignup);
    }
